...
const SectionHeader = ({ title }: { title: string }) => (
  <h2 className="text-[10px] uppercase tracking-[0.3em] text-primary mb-6 flex items-center gap-2">
...
const ProjectCard = ({ title, tags, description }: { title: string; tags: string; description: string }) => (
  ...
  >
    <div className="flex justify-between items-start mb-3">
      ...
      <span className="bg-secondary/10 text-secondary text-[9px] px-2 py-1 rounded border border-secondary/20 font-mono tracking-tighter">
        {tags}
      </span>
    </div>
  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 selection:bg-primary/30 selection:text-white">
      <motion.main 
        ...
        className="max-w-4xl mx-auto bg-dark/90 backdrop-blur-md border border-primary/20 p-8 md:p-16 rounded-sm relative overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)]"
      >
        {/* Top Gradient Line */}
        ...
        <header className="border-b border-white/5 pb-10 mb-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          ...
          <div className="text-[11px] text-slate-400 font-mono space-y-2 md:text-right tracking-wider">
            <a 
        ...
        <section className="border-b border-white/5 pb-10 mb-10">
          ...
          <p className="text-slate-300 leading-relaxed max-w-3xl font-mono text-xs tracking-wide">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={idx} className="flex flex-col sm:flex-row justify-between items-start sm:items-center group">
                ...
                <span className="text-accent font-mono text-[10px] tracking-widest mt-1 sm:mt-0 opacity-80">
                  {job.period}
                </span>
              </div>
            ))}
        ...
        <section className="border-b border-white/5 pb-10 mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="md:pl-8">
              ...
              <ul className="text-[11px] text-slate-400 space-y-3 font-mono tracking-wider">
        ...
        <section>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start">
            ...
            <div className="text-slate-500 font-mono text-[11px] sm:text-right mt-4 sm:mt-0 space-y-1">
      ...
      {/* Footer */}
      <footer className="text-center mt-12 text-slate-600 font-mono text-[9px] uppercase tracking-[0.4em] opacity-50">
